...
public class OrdersResource {
    ...
    public ResponseEntity<Orders> updateOrders(@PathVariable(value = "id", required = false) final UUID id, @RequestBody Orders orders)
    ...
    public ResponseEntity<Orders> getOrders(@PathVariable UUID id) {
