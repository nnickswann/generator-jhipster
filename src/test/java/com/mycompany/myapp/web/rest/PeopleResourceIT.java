...
class PeopleResourceIT {
    ...
    void getAllPeople() throws Exception {
        ...
        restPeopleMockMvc
            ...
            .andExpect(jsonPath("$.[*].id").value(hasItem(people.getId().toString())))
    ...
    void getPeople() throws Exception {
        ...
        restPeopleMockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.id").value(people.getId().toString()))
    ...
    void getNonExistingPeople() throws Exception {
        // Get the people
        restPeopleMockMvc.perform(get(ENTITY_API_URL_ID, UUID.randomUUID().toString())).andExpect(status().isNotFound());
    }
    ...
    void deletePeople() throws Exception {
        ...
        // Delete the people
        restPeopleMockMvc
            .perform(delete(ENTITY_API_URL_ID, people.getId().toString()).with(csrf()).accept(MediaType.APPLICATION_JSON))
